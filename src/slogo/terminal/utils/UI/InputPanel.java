...
public class InputPanel extends HBox {
   ...
   */
  public void setPositionCaretAtEnding() {
  ...
  public String formatText(String str) {
    return String.format("%s%s", NON_TERMINAL_USER_INPUT_CODE, str);
  }
   ...
   * @return string
   */
  public String getTERMINAL_USER_INPUT_CODE() {
    return TERMINAL_USER_INPUT_CODE;
  }
